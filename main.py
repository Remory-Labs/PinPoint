...
def main():
    ...
    c1 = Camera("video", "front", "blaze", "vids/sess2/front.mp4")
    c2 = Camera("video", "left", "blaze", "vids/sess2/left.mp4")
    c3 = Camera("video", "right", "blaze", "vids/sess2/right.mp4")
    c4 = Camera("video", "back", "blaze", "vids/sess2/back.mp4")
    c5 = Camera("video", "right", "dnn", "vids/sess2/right_forBack.mp4")
    #cameras.append(c1)
    #cameras.append(c2)
    #cameras.append(c3)
    cameras.append(c4)
